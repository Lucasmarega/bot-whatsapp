...
function getMensagem() {
    ...
    // -----------------------------------------------------------
    return `${saudacao}, eu gostaria de te fazer um convite para o evento que ocorrerá no dia //** add data aqui*// sábado, das 09:00 horas da manhã até as 16:00 horas da tarde aqui na //**nome da empresa ou instituição e cidade**//.

📍 //**coloque o endereço aqui**//

✏️ //** complete a mensagem aqui **//
